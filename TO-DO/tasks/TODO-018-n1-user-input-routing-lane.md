...
The point is not to make N1 more verbose. The point is to make N1 choose the right execution posture early, so user intent lands in the right bounded system instead of being reinterpreted from scratch every session.
