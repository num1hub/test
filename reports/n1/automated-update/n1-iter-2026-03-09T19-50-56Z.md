...
- Iteration: `n1-iter-2026-03-09T19-50-56Z`
...
2. Review those ten hubs against live docs, code, and tests.
3. Force one explicit branch decision per hub: `promote`, `retain-dream`, or `rewrite`.
4. Split unresolved rewrite work into bounded follow-up tasks instead of widening this packet.
