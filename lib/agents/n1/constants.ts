...
export const SCHEDULER_STATE_PATH = "data/private/agents/n1/scheduler.state.json";
export const SCHEDULER_LATEST_PATH = "data/private/agents/n1/scheduler.latest.json";
export const SCHEDULER_HISTORY_PATH = "data/private/agents/n1/scheduler.history.jsonl";
...
export const SCHEDULER_REPORTS_DIR = "reports/n1/scheduler";
